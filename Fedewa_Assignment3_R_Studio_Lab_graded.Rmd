...
/Users/rileyfedewa/Documents/IHSD_7440_HH_Sampling
...
# Take a look at your child dataset and you will see that you only need to rename the following:

names(Zambia_chld_df)[names(Zambia_chld_df) == "V022"] <- "Sample_stratum_number"
names(Zambia_chld_df)[names(Zambia_chld_df) == "V023"] <- "Sample_domain"
names(Zambia_chld_df)[names(Zambia_chld_df) == "V002"] <- "Household_number"
names(Zambia_chld_df)[names(Zambia_chld_df) == "V005"] <- "Sample_weight"
names(Zambia_chld_df)[names(Zambia_chld_df) == "V021"] <- "Primary_sampling_unit"
names(Zambia_chld_df)
```
